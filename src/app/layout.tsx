...
export const metadata: Metadata = {
  title: {
    default: "제이앤대부(제이앤대부전당) - 광주 정식등록 대부업체",
    template: "%s | 제이앤대부",
  },
  description:
    "제이앤대부전당 - 광주 정식등록 대부업체. 자동차담보, 전월세, 무직자, 비상금 대출. 당일승인, 수수료 0원.",
  keywords: [
    "제이앤대부",
    "제이앤대부전당",
    "광주대부업",
  ...
  verification: {},
  other: {
    "naver-site-verification": "f0d71b40c0b8e6f62ffa938bc6e1f7897d6c475e",
  },
};
  ...
  return (
    <html lang="ko" className="h-full antialiased">
      <head>
        ...
        <script
          async
          src="https://www.googletagmanager.com/gtag/js?id=AW-17996576930"
        />
        <script
